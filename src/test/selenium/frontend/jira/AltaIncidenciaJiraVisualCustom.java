...
public class AltaIncidenciaJiraVisualCustom {
...
//	public void ingreso(String url, String usuario, String password) {
	...
	@Test
	public void testAltaIncidenciaJiraVisual() throws Exception {
		try {
